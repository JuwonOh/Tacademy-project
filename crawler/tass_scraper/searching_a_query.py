...
import os
import re
from tass_scraper import yield_latest_article
from tass_scraper import now
import unicodedata
...
def main():
    ...
    parser.add_argument(
        "--directory",
        type=str,
        default="C:/Users/13a71/Documents/crawling output/tass",
    ...
    parser.add_argument(
        "--max_page", type=int, default=1417071, help="Number of scrapped articles page"
    )
    parser.add_argument(
        "--begin_date", type=str, default="2021-08-01", help="Number of start documents"
    )
