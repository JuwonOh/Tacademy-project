...
def save(json_obj, directory):
    ...
    filepath = '{}/{}_{}.json'.format(directory, date, re.sub("[\/:*?\<>|%]","", title[:50]))
...
def main():
    ...
    parser.add_argument('--begin_date', type=str, default='2021-05-01', help='datetime YYYY-mm-dd')
    parser.add_argument('--directory', type=str, default='C:/Users/13a71/Documents/crawling output/whitehouse_outcome', help='Output directory')
