...
def main():
    ...
    today = now()[:10]
    parser.add_argument('--directory', type=str, default='C:/Users/13a71/Documents/crawling output/globaltimes_outcome', help='Output directory')
    parser.add_argument('--sleep', type=float, default=0.0000001, help='Sleep time for each submission (post)')
    parser.add_argument('--max_page', type=int, default=1250241, help='Number of scrapped articles page')
    parser.add_argument('--begin_date', type=str, default= "2022-01-01", help='Number of start documents')
