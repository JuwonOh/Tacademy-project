...
def save(json_obj, directory):
    ...
    filepath = "{}/{}_{}.json".format(
        directory, date, re.sub("[^a-zA-Z ]+", "", title[10:50])
    )
...
def main():
    ...
    parser.add_argument(
        "--section", type=str, default="News", help="datetime YYYY-mm-dd"
    )
    parser.add_argument(
        "--directory",
        type=str,
        default="C:/Users/13a71/Documents/crawling output/chn_fm",
