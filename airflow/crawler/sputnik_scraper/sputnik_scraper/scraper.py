...
def yield_latest_article(begin_date, end_date, sleep, section, verbose=True):
    ...
    """
    daily_datarange = pd.date_range(start=begin_date, end=end_date, freq="b")

    for date in daily_datarange:
        base_url = (
            "https://sputniknews.com/services/{}/more.html?date={}&tags=1"
        )
        ...
        daily_url = set(
            ["https://sputniknews.com" + a.find("a")["href"] for a in sub_urls]
        )
