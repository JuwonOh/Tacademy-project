...
from sputnik_scraper import now, yield_latest_article
...
def main():
    ...
    parser.add_argument(
        "--directory",
        type=str,
        default="C:/Users/13a71/Documents/crawling output/sputnik_outcome",
    ...
    parser.add_argument(
        "--section", type=str, default=1000, help="Choose newspaper`s section"
    )
    parser.add_argument(
        "--end_date",
        type=str,
        default="2021-10-01",
        help="Number of end documents",
    )
    parser.add_argument(
        "--begin_date",
        type=str,
